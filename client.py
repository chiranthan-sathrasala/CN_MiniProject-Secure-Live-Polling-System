...
# Injects a fully functional mock of the old wrap_socket for Python 3.12+
# because the dtls library passes deprecated arguments that SSLContext.wrap_socket rejects.
